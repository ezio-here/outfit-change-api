...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .cat-scroll::-webkit-scrollbar-thumb { background: #2a3450; border-radius: 10px; }
        .cat-pill { padding: 8px 16px; border-radius: 99px; background: #11172b; border: 1px solid #2a3450; color: #eee; font-weight: 500; cursor: pointer; white-space: nowrap; font-size: 0.9rem; transition: all 0.2s; }
        .cat-pill.active { background: #ffcc00; color: #0a0f1e; border-color: #ffcc00; font-weight: 600; }
        .item-card.no-equip { opacity: 0.45; cursor: not-allowed; }
        .item-card.no-equip:hover { transform: none; border-color: #2a3450; }
        .no-equip-badge { font-size: 0.65rem; color: #ff8888; margin-top: 4px; }
